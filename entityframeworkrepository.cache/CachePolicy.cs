...
namespace entityframeworkrepository.cache
{
    ...
    {
        private static readonly Lazy<ICachePolicy> _current = new Lazy<ICachePolicy>(() => new CachePolicy());

        /// <summary>
        /// Gets the default <see cref="CachePolicy"/>.
        /// </summary>
        public static ICachePolicy Default
        {
        ...
        public static ICachePolicy WithDurationExpiration(TimeSpan expirationSpan)
        {
        ...
        /// <returns>An instance of <see cref="CachePolicy"/>.</returns>
        public static ICachePolicy WithAbsoluteExpiration(DateTimeOffset absoluteExpiration)
        {
            var policy = new CachePolicy
            {
        ...
        /// <returns>An instance of <see cref="CachePolicy"/>.</returns>
        public static ICachePolicy WithSlidingExpiration(TimeSpan slidingExpiration)
        {
            var policy = new CachePolicy
            {
