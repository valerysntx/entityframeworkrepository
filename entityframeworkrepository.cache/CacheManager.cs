...
namespace entityframeworkrepository.cache
{
    ...
    public class CacheManager
    {
        ...
        public bool Add(string key, object value, ICachePolicy absoluteExpiration)
        {
        ...
        {
            ICachePolicy cachePolicy = CachePolicy.WithAbsoluteExpiration(absoluteExpiration);
            return Add(key, value, cachePolicy);
        }
        ...
        /// or the new value if the key was not in the dictionary.
        /// </returns>
        public object GetOrAdd(string key, object value, ICachePolicy cachePolicy)
        {
            ICacheKey cacheKey = new CacheKey(key);
        ...
        /// or the new value if the key was not in the dictionary.
        /// </returns>
        public object GetOrAdd(ICacheKey key, object value, ICachePolicy cachePolicy)
        {
        ...
        /// or the new value for the key as returned by <paramref name="valueFactory"/> if the key was not in the dictionary.
        /// </returns>
        public object GetOrAdd(string key, Func<string, object> valueFactory, ICachePolicy cachePolicy)
        {
            var cacheKey = new CacheKey(key);
        ...
        /// or the new value for the key as returned by <paramref name="valueFactory"/> if the key was not in the dictionary.
        /// </returns>
        public virtual object GetOrAdd(ICacheKey cacheKey, Func<ICacheKey, object> valueFactory, ICachePolicy cachePolicy)
        {
            var provider = ResolveProvider();
        ...
        /// <param name="value">The object to insert.</param>
        /// <param name="cachePolicy">An object that contains eviction details for the cache entry.</param>
        public void Set(string key, object value, ICachePolicy cachePolicy)
        {
            var cacheKey = new CacheKey(key);
        ...
        /// <param name="value">The object to insert.</param>
        /// <param name="cachePolicy">An object that contains eviction details for the cache entry.</param>
        public virtual void Set(ICacheKey cacheKey, object value, ICachePolicy cachePolicy)
        {
            var provider = ResolveProvider();
